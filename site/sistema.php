    ...
    <section class="section-1"> <!-- Inicio do conteudo Primario -->
      ...
      <div class="box">
        <div class="form-box">
          ...
          <form action="../SGBD/upload.php" method="post" enctype="multipart/form-data">



            <h3>Olá, discente. Para enviar seu PCCT, clique abaixo:</h3>

            
            
            <div class="input-group">
              <label for="nome_arquivo"> Nome do PCCT</label>
              <input type="text" name="nome_arquivo" placeholder="Digite aqui o nome" required>
            </div>

            
            <div class="input-group-pdf">
