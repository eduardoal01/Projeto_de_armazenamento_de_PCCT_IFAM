...
if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($conexao, "INSERT INTO cadastro(nome,matricula,email,curso,turma,genero,senha) VALUE('$nome','$matricula','$email','$curso','$turma','$genero','$senha')");
        ...
        <div class="form-box">
          ...
          <form action="Cadastro.php" method="POST">
            ...
            <div class="input-group">
                ...
                <input type="text" name="matricula" placeholder="Digite o sua matricula" required>
            </div>
            ...
            <div class="input-box">
              ...
              <input type="radio" id="adm" name="curso" value="Administracao" required>
              <label for="adm">Administração</label>
              
              <input type="radio" id="agro" name="curso" value="Agropecuaria" required>
              <label for="agro">Agropecuaria</label>

              <input type="radio" id="inf" name="curso" value="Informatica" required>
            ...
            <div class="input-box">
              ...
              <input type="radio" id="adm31" name="turma" value="ADM 31" required>
              <label for="adm31">ADM 31</label>
              
              <input type="radio" id="agro31" name="turma" value="AGRO 31" required>
              <label for="agro31">AGRO 31</label>
              <input type="radio" id="inf31" name="turma" value="INF 31" required>
              <label for="inf31">INF 31</label>
            ...
            <div class="input-group">
              <input class="enviar-cadastro" type="submit" name="submit" value="Cadastrar">
            </div>
